...
export const scenarioFixtures: Record<CoreMockScenario, ScenarioFixture> = {
    ...
    empty: {
        ...
        ...{
            ...
            notificationsAllowed: true,
            progressTrackingEnabled: true,
            bookKey: 'standardBook' as const,
            plan: {
                ...basePlan,
                planId: 'fixture-plan-empty',
                bookId: fixtureBooks.standardBook.id,
                state: 'scheduled',
                result: 'attempted',
                scheduledAt: '2026-03-11T21:00:00.000Z',
            ...
            mainMode: 'normal_15m' as const,
            subMode: 'rescue_5m' as const,
            rehabMode: null,
        },
    },
    no_cover: {
        ...
        ...{
            ...
            notificationsAllowed: true,
            progressTrackingEnabled: true,
            bookKey: 'missingCoverBook' as const,
            plan: {
                ...basePlan,
                planId: 'fixture-plan-no-cover',
                bookId: fixtureBooks.missingCoverBook.id,
                state: 'scheduled',
                result: 'attempted',
                scheduledAt: '2026-03-11T21:00:00.000Z',
    ...
    cover_removed: {
        ...
        ...{
            ...
            plan: {
                ...basePlan,
                planId: 'fixture-plan-cover-removed',
                bookId: fixtureBooks.missingCoverBook.id,
                state: 'scheduled',
                result: 'attempted',
                scheduledAt: '2026-03-11T21:00:00.000Z',
