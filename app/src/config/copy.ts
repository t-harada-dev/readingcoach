...
export const copy = {
  ...
  restartRecovery: {
    title: '今日は1分だけでも大丈夫です',
    subtitle: '重く考えず、まず再開することだけを考えましょう',
    ctaStartIgnition: '1分だけ読んでみる',
    ctaChangeTime: '時間を変える',
    ctaChangeBook: '本を変える',
    startError: '開始できませんでした。少し待って再試行してください。',
  },
  onboardingTime: {
    title: '読む時間を決める',
    subtitle: '毎日の開始時刻を自由に設定できます',
    labelHour: '時',
    labelMinute: '分',
    ctaSave: 'この時刻で保存',
  },
  ...
  settings: {
    ...
    ctaSaveTime: '読書時間を保存',
    ctaEnableNotification: '通知を有効にする',
    ctaDisableNotification: '通知を無効にする',
  },
  focusBookPicker: {
    title: '本を切り替える',
    subtitle: '',
  ...
  bookDetail: {
    ...
    labelCoverImage: '表紙画像',
    ctaTakePhoto: 'カメラで撮影',
    ctaPickImage: '端末から選択',
    ctaSave: '保存する',
    ctaSetFocusBook: 'この本を読む',
    ctaEnableProgress: '進捗バーを有効化する',
    ctaDisableProgress: '進捗バーを無効化する',
    progressDisabled: '進捗バーは現在 OFF です（任意機能）',
    progressGuardTitle: '進捗バーをONにできません',
    progressGuardMissingPageCount: '総ページ数を入力してください（1以上）。',
    progressGuardInvalidPageCount: '総ページ数は1以上の数値で入力してください。',
    progressGuardMissingCurrentPage: '現在ページを入力してください（0以上）。',
    progressGuardInvalidCurrentPage: '現在ページは0以上の数値で入力してください。',
